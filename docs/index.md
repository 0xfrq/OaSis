...
proyek ini mencakup 33 file sumber (c, assembly, header) yang mencakup booting, protected mode, paging, multitasking, filesystem, syscall, compiler, assembler, dan user mode.
...
| syscall layer (23 syscall, ring 0 + ring 3) | selesai | syscall.c, interrupt.asm |
...
src/
  ...
  kernel/
    ...
    syscall/     syscall.c (23 syscall dispatcher), interrupt.asm (irq + syscall handler)
