...
tampilkan 20 baris dari posisi scroll. setiap baris di-render langsung ke vga buffer. status bar di baris 24 (terakhir) nampilin filename, line, column.
...
assembler x86 32-bit lengkap ~1400 baris. menghasilkan machine code yang langsung di-eksekusi.
...
compiler subset c yang terdiri dari 3 komponen:
1. lexer.c -> tokenizer
