...
C_SOURCES = kernel/kernel.c kernel/vga.c kernel/keyboard.c kernel/io.c kernel/string.c kernel/idt.c kernel/pic.c kernel/timer.c kernel/memory.c kernel/paging.c kernel/pmm.c
